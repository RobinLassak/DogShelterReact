            ...
            <div className="col-sm-12 col-md-9 col-lg-5 col-12 my-5">
              <table className="table table-dark table-striped">
                ...
                <tbody>
                  <tr>
                    <td>Granule</td>
                    <td>{aktualniZasoby.granule}</td>
                    <td>Kg</td>
                  </tr>
                  <tr>
                    <td>Vakciny</td>
                    <td>{aktualniZasoby.vakciny}</td>
                    <td>Ks</td>
                  </tr>
                  <tr>
                    <td>Leky</td>
                    <td>{aktualniZasoby.leky}</td>
                    <td>Ks</td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="col-12 d-flex justify-content-center">
              <div className="shelter-form">
                ...
                <button
                  ...
                  disabled={!validaceZasoby}
                  onClick={handlePridaniZasob}
                >
                  Pridej do skladu
                </button>
              </div>
